...
python3 -u run.py --task method_naming --num_classes 104 --reps ast cfg ddg --max_contexts '{"ast":"200", "cfg":"10", "ddg":"100"}' --data ${data} --test ${val_data} --save ${model_dir}/saved_model

## Evaluate a trained model on test data (by loading the model)
# python3 -u run.py --task method_naming --num_classes 104 --reps ast cfg ddg --max_contexts '{"ast":"200", "cfg":"10", "ddg":"100"}' --load ${model_dir}/saved_model --test ${test_data}
